...
export const registerWebAccount=(username:string,password:string,locale:'ar'|'en')=>apiPost<{id:number;username:string;locale:'ar'|'en'}>('/auth/register',{username,password,locale})
